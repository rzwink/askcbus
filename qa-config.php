...
*/
	...
	define('QA_MYSQL_HOSTNAME', $_SERVER["QA_MYSQL_HOSTNAME"]);
	define('QA_MYSQL_USERNAME', $_SERVER["QA_MYSQL_USERNAME"]);
	define('QA_MYSQL_PASSWORD', $_SERVER["QA_MYSQL_PASSWORD"]);
	define('QA_MYSQL_DATABASE', $_SERVER["QA_MYSQL_DATABASE"]);
